...
const UIServices = () => {
  ...
  return (
    <div className="position-relative">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-blue-600 to-indigo-700 text-white py-20 mt-20 overflow-auto">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-16" data-aos="fade-up">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-gray-900 to-blue-600 bg-clip-text text-transparent">
              Our Design Process
            </h2>
          ...
          <div className="relative">
            {/* Connection Line */}
            <div className="hidden lg:block absolute top-1/2 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-200 via-green-200 via-cyan-200 to-yellow-200 transform -translate-y-1/2"></div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 relative z-10">
              ...
              <div className="group" data-aos="fade-up" data-aos-delay="100">
                <div className="relative p-8 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-blue-100 hover:border-blue-200 hover:-translate-y-2">
                  {/* Step Number */}
                  <div className="absolute -top-6 left-1/2 transform -translate-x-1/2">
                    <div className="w-12 h-12 flex items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold text-lg shadow-lg">
                      1
                    </div>
                  </div>
                  ...
                  <h5 className="text-xl font-bold mb-4 text-gray-900 text-center">Discovery</h5>
                  <p className="text-gray-600 text-center leading-relaxed">
                  Deep dive into goals, audience, and requirements to build a strong foundation for project success.
                  </p>
                  
                  {/* Duration */}
                  <div className="mt-6 pt-4 border-t border-gray-100">
                    <span className="text-sm text-blue-600 font-medium">1-2 weeks</span>
                  </div>
                </div>
              </div>
              ...
              <div className="group" data-aos="fade-up" data-aos-delay="200">
                <div className="relative p-8 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-green-100 hover:border-green-200 hover:-translate-y-2">
                  <div className="absolute -top-6 left-1/2 transform -translate-x-1/2">
                    <div className="w-12 h-12 flex items-center justify-center rounded-full bg-gradient-to-r from-green-500 to-green-600 text-white font-bold text-lg shadow-lg">
                      2
                    </div>
                  </div>
                  
                  <div className="w-16 h-16 bg-green-50 rounded-xl flex items-center justify-center mx-auto mb-6 group-hover:bg-green-100 transition-colors">
                    <TrendingUp className="w-8 h-8 text-green-600" />
                  </div>
                  
                  <h5 className="text-xl font-bold mb-4 text-gray-900 text-center">Research</h5>
                  <p className="text-gray-600 text-center leading-relaxed">
                    Comprehensive market analysis, competitor research, and user behavior studies to inform design decisions
                  </p>
                  
                  <div className="mt-6 pt-4 border-t border-gray-100">
                    <span className="text-sm text-green-600 font-medium">1-3 weeks</span>
                  </div>
                </div>
              </div>
              ...
              <div className="group" data-aos="fade-up" data-aos-delay="300">
                <div className="relative p-8 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-cyan-100 hover:border-cyan-200 hover:-translate-y-2">
                  <div className="absolute -top-6 left-1/2 transform -translate-x-1/2">
                    <div className="w-12 h-12 flex items-center justify-center rounded-full bg-gradient-to-r from-cyan-500 to-cyan-600 text-white font-bold text-lg shadow-lg">
                      3
                    </div>
                  </div>
                  
                  <div className="w-16 h-16 bg-cyan-50 rounded-xl flex items-center justify-center mx-auto mb-6 group-hover:bg-cyan-100 transition-colors">
                    <Palette className="w-8 h-8 text-cyan-600" />
                  </div>
                  
                  <h5 className="text-xl font-bold mb-4 text-gray-900 text-center">Design</h5>
                  <p className="text-gray-600 text-center leading-relaxed">
                    Creating wireframes, interactive prototypes, and stunning visual designs with continuous user feedback
                  </p>
                  
                  <div className="mt-6 pt-4 border-t border-gray-100">
                    <span className="text-sm text-cyan-600 font-medium">2-4 weeks</span>
                  </div>
                </div>
              </div>
              ...
              <div className="group" data-aos="fade-up" data-aos-delay="400">
                <div className="relative p-8 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-yellow-100 hover:border-yellow-200 hover:-translate-y-2">
                  <div className="absolute -top-6 left-1/2 transform -translate-x-1/2">
                    <div className="w-12 h-12 flex items-center justify-center rounded-full bg-gradient-to-r from-yellow-500 to-yellow-600 text-white font-bold text-lg shadow-lg">
                      4
                    </div>
                  </div>
                  
                  <div className="w-16 h-16 bg-yellow-50 rounded-xl flex items-center justify-center mx-auto mb-6 group-hover:bg-yellow-100 transition-colors">
                    <Code className="w-8 h-8 text-yellow-600" />
                  </div>
                  
                  <h5 className="text-xl font-bold mb-4 text-gray-900 text-center">Development</h5>
                  <p className="text-gray-600 text-center leading-relaxed">
                    Building the final product with clean, maintainable code and rigorous testing for optimal performance
                  </p>
                  
                  <div className="mt-6 pt-4 border-t border-gray-100">
                    <span className="text-sm text-yellow-600 font-medium">3-8 weeks</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-16 text-center" data-aos="fade-up" data-aos-delay="500">
            <div className="inline-flex items-center gap-4 px-6 py-3 bg-white rounded-full shadow-lg border border-gray-100">
              ...
              <span className="text-gray-700 font-medium">Agile methodology with weekly updates</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-center">
            <div className="text-center max-w-3xl" data-aos="fade-up">
              ...
              <a data-lov-id="src\pages\UIServices.tsx:157:14" data-lov-name="a" data-component-path="src\pages\UIServices.tsx" data-component-line="157" data-component-file="UIServices.tsx" data-component-name="a" data-component-content="%7B%22text%22%3A%22Get%20Started%22%2C%22className%22%3A%22inline-flex%20items-center%20gap-2%20px-6%20py-3%20border%20border-white%20font-semibold%20rounded-lg%20hover%3Abg-white%20hover%3Atext-blue-700%22%7D" href="/contact" className="inline-flex items-center gap-2 px-6 py-3 border border-white font-semibold rounded-lg hover:bg-white hover:text-blue-700">
              Start Your Project
              
              <ArrowRight size={20} aria-hidden="true" /></a>
