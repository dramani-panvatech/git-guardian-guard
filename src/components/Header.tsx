      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
                ...
                <div className="absolute top-full left-0 mt-2 w-80 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-secondary-200/50 p-4 animate-in slide-in-from-top-2 duration-300">
                  <div className="grid gap-2">
                    <a
                      ...
                      className="flex items-center gap-3 p-3 rounded-xl hover:bg-primary-50 transition-all duration-200 hidden"
                    ...
                    >
                      ...
                      <div>
                        <div className="font-medium text-secondary-900">Products</div>
          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            <button
              className="p-2 border-0 rounded-lg hover:bg-secondary-100 transition-colors btn btn-primary"
              type="button"
              onClick={toggleMenu}
